...
lblMsg = Label(f1, font = ('arial', 18, 'bold'),
		text = "By using AES", bd = 18, anchor = "w")
...
lblMsg = Label(f1, font = ('arial', 18, 'bold'),
		text = "By using MD5", bd = 18, anchor = "w")
...
# Reset button
btnReset = Button(f1, padx = 5, pady = 5, bd = 5,
				fg = "black", font = ('arial', 16, 'bold'),
					width = 10, text = "Reset", bg = "green",
				command = Reset).grid(row = 10, column = 2)

# Exit button
btnExit = Button(f1, padx = 5, pady = 5, bd = 5,
				fg = "black", font = ('arial', 16, 'bold'),
